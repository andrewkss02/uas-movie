...
class MainActivity : AppCompatActivity() {
    ...
    private fun isiGambar( txtHello: TextView, image1: ImageView){
        ...
        when (tes) {
            1 -> image1.setImageDrawable(getDrawable(R.drawable.naruto1))
            2 -> image1.setImageDrawable(getDrawable(R.drawable.naruto2))
            3 -> image1.setImageDrawable(getDrawable(R.drawable.naruto3))
            4 -> image1.setImageDrawable(getDrawable(R.drawable.naruto4))
            5 -> image1.setImageDrawable(getDrawable(R.drawable.naruto5))
            else -> { // Note the block
                image1.setImageDrawable(getDrawable(R.drawable.naruto6))
